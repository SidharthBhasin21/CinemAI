  ...
  return (
    <div className="pt-[20%] px-24 absolute text-white bg-gradient-to-tr from-black w-screen aspect-video">
      ...
      <div className="flex gap-5">
        <button className=" bg-white rounded-md font-bold text-black py-3 px-16  hover:bg-opacity-80">
          Play
        </button>
        <button className=" bg-slate-500 rounded-md font-bold text-white py-3 px-16 bg-opacity-50 hover:bg-opacity-70">
          More info
        </button>
      </div>
    </div>
